...
const inventors = [
  ...
  {first: 'Marie', last: 'Curi', year: 1867, passed: 1934},
  {first: 'Johannes', last: 'Kepler', year: 1571, passed: 1630},
  {first: 'Nicolaus', last: 'Copernicus', year: 1473, passed: 1543},
  {first: 'Max', last: 'Planck', year: 1858, passed: 1947},
  ];

const people = ['Beck, Glenn', 'Becker, Carl', 'Beckett, Samuel', 'Bedoes, Mick', 'Beecher, Henry',
    ...
    'Birrell, Augustine', 'Back, Elk', 'Blair, Robert', 'Blair, Tony', 'Blake, William'];
...
// 1. Filter the list of inventors for those who werw born in the 1500’s
